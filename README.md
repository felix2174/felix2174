...
Real-time detection of prompt injection, jailbreaks, code injection, social engineering and data exfiltration. **245 patterns across 12 categories in 15 languages.** Zero LLM dependency, <6ms latency.
...
REST API for AI security: 245 patterns, PDF compliance reports mapped to EU AI Act (Art. 9, 15, 17, 61). Free tier, Pro & Enterprise plans. Stripe payments, Docker-deployed.
...
| 🧪 [Prompt Lab](https://github.com/joergmichno/prompt-lab) | Interactive Prompt Injection Playground — test 245 patterns in real time. [Live →](https://prompttools.co) |
